// velocity-react v1.3.3
declare module 'velocity-react' {
  import { TransitionGroup } from 'react-transition-group';

  export class VelocityComponent extends React.Component<VelocityComponentProps & Velocity.VelocityOptions> {}
  export class VelocityTransitionGroup extends React.Component<
    VelocityTransitionGroupProps & TransitionGroup.TransitionGroupProps
  > {
    static disabledForTest: boolean;
  }
  export const velocityHelpers: { registerEffect: RegisterEffect };
  ...
  interface VelocityTransitionGroupProps extends Velocity.VelocityOptions {
    runOnMount?: boolean;
    enter?: Animation;
    leave?: Animation;
    children?: React.ReactNode;
  ...
  type InterruptBehavior = 'stop' | 'finish' | 'queue';
  ...
  // from https://github.com/julianshapiro/velocity/blob/master/index.d.ts
  // Latest commit 74e32cc
  namespace Velocity {
    /**
     ...
     * value is ignored.
     */
    type VelocityNormalizationsFn = ((element: HTMLorSVGElement, propertyValue: string) => void) &
     ...
     */
    type VelocityProperties = { [property in keyof CSSStyleDeclaration]?: VelocityProperty };

    /**
     * A callback used at the beginning or end of an animation.
     */
    type VelocityCallback = (
    ...
    interface VelocityPromise {
       ...
       */
      _resolver?: (
        value?: (HTMLorSVGElement[] & VelocityExtended) | PromiseLike<HTMLorSVGElement[] & VelocityExtended>
      ) => void;
      /**
       * This method is called at most once to signify that the animation has
       * completed. Currently a loop:true animation will never complete. This
     ...
     */
    type VelocitySequenceProperties = { [property in keyof CSSStyleDeclaration]?: VelocitySequenceProperty };
   ...
   const enum AnimationFlags {
    ...
    interface VelocityChain {
      ...
      (
        propertyMap: string | VelocityProperties,
    ...
    interface Velocity {
      ...
      (
        elements: VelocityElements,
        propertyMap: VelocityProperties,
        duration?: number | 'fast' | 'normal' | 'slow',
        complete?: () => void
      ): VelocityResult;
      (
      ...
      RunSequence(originalSequence: any): void;
      RegisterEffect(effectName: string, properties: any): Velocity;
    ...
    interface Velocity {
      (
        ...
        percentComplete: number,
        property: string,
        value: VelocityPropertyValue,
        easing?: VelocityEasingType
      ): string;
      (action: 'tween', percentComplete: number, propertyMap: VelocityProperties, easing?: VelocityEasingType): {
